"""
 Music player with color light for [ReSpeaker](respeaker.io)
...
class Player:
    ...
    def play(self, wav_file, quit_event=None, hook=None):
...
def show(data):
    spi.write(address=0xA0, data=data)
...
def main():
    ...
    quit_event = threading.Event()
    player.play(song, quit_event, show)
